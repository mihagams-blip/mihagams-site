#!/usr/bin/env python3
"""Normalise a generated ronin sprite sheet into assets/zenko.webp.
...
out.save("assets/zenko.webp", "WEBP", quality=90, method=6)
print("assets/zenko.webp", os.path.getsize("assets/ronin.webp") // 1024, "KB", out.size)
