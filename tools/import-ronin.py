#!/usr/bin/env python3
"""Normalise a generated ronin sprite sheet into assets/ronin.webp.
...
out.save("assets/ronin.webp", "WEBP", quality=90, method=6)
print("assets/ronin.webp", os.path.getsize("assets/ronin.webp") // 1024, "KB", out.size)
