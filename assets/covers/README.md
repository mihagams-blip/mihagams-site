...
All four featured tracks now have artwork. To change one: drop a new square
image here, point `cover` at it in `js/data.js`, update `coverAlt`, and run
`node tools/bake.mjs`.

| Track | File |
| --- | --- |
| Blade Smile | `blade-smile.webp` |
| Fuego y Piel | `fuego-y-piel.webp` |
| A Blue Ember in the Dark | `a-blue-ember-in-the-dark.webp` |
| It's Made of Scars | `its-made-of-scars.webp` |
